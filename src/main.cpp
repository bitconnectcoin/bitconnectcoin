...
int nCoinbaseMaturity = 50; //Coin Base Maturity
...
const string strMessageMagic = "bitconnect Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 10 * COIN; //Miner reward

            if(nBestHeight == 0)
            {
            nSubsidy = 4819323 * COIN; //Total premine coin
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bitconnect", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1482537601;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 70353 : 70353;
        ...
        assert(block.hashMerkleRoot == uint256("0x2bf84615b1764b410285da38aa6a724b84ddd62b4a5dcec70a4c1bbaf6a09c09"));
